...
from database.db import check_teacher_exists, create_teacher, teacher_login, get_teacher_subjects, get_attendance_for_teacher
...
def teacher_screen_login():
    ...
    st.markdown(
            "<h2 style='color:black; text-align:center;'>Login using password</h2>",
            unsafe_allow_html=True
        )
...
def teacher_screen_register():
    ...
    st.markdown(
            "<h2 style='color:black; text-align:center;'>Register your teacher profile</h2>",
            unsafe_allow_html=True
        )
